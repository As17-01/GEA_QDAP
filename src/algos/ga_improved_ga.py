...
class ImprovedGA(BaseGA):
    """GEA infrastructure (diversity-aware selection, RF repair, stagnation immigrants,
    memetic local search) with only standard crossover and mutation — no RC/DM/GI
    scenario operators.
    """
