...
class GEA(BaseGA):
    ...
    on top of fixed crossover/mutation rates. See ga_standard.py for the textbook
    (Holland, 1992) baseline this is compared against, and ga_adaptive.py for the variant
    that scales these same rates by performance-adaptive lambda multipliers.
    """
