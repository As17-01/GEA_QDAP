...
class AdaptiveGEAScenario3(BaseGA, AdaptiveRatesMixin):
    """GEA Scenario 3 (gene injection) with lambda-scaled crossover, mutation, and GI rates."""
    ...
    def step(self) -> None:
        ...
        injected = self._adaptive_gene_injection()
